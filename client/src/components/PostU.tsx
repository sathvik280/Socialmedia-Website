...
import { UserPostProps, Post, User, Store } from '../types/interface';

const PostU: React.FC<UserPostProps> = (props): JSX.Element => {
    const { post, updateUserPostLikes }: {
        post: Post, 
    ...
    const updatesLikes = () => {
        ...
        updateUserPostLikes(post._id, newLikes);
    };
