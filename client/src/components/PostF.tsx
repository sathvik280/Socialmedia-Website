...
import { PostProps, Post, Store, User } from '../types/interface';

const PostF: React.FC<PostProps> = (props): JSX.Element => {
    const { post }: {
        post: Post
    } = props;
                    ...
                    onClick={ () => {
                        ...
                        navigate(`/user`, {
                            state: {
                                ...
                                imageName: post.userImageName,
                                imageUrl: post.userImageUrl,
                                occupation: post.userOccupation 
                            }
                        });
                    }}              
                >
